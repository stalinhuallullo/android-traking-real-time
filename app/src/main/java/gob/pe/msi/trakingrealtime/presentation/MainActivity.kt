package gob.pe.msi.trakingrealtime.presentation
...
class MainActivity : AppCompatActivity(), View.OnClickListener, EasyPermissions.PermissionCallbacks {
    ...
    override fun onResume() {
        super.onResume()
        LocalBroadcastManager.getInstance(this@MainActivity).registerReceiver(receiver, IntentFilter("gob.pe.msi.trakingrealtime.ADD_ITEM"))
    }
